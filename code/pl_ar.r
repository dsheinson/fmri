...
require(doMC)
registerDoMC()
data1 = expand.grid(mod.sim="M101",mod.est="M011",n.run=1:3,n.par=591:592,n.sim=1,np=500,sd.fac=1,mle=TRUE)
data2 = expand.grid(mod.sim="M011",mod.est="M101",n.run=1:3,n.par=591:592,n.sim=1,np=500,sd.fac=1,mle=TRUE)
data3 = expand.grid(mod.sim="M101",mod.est="M101",n.run=1:3,n.par=591:592,n.sim=1:3,np=500,sd.fac=c(1,5,10,15),mle=TRUE)
data4 = expand.grid(mod.sim="M011",mod.est="M011",n.run=1:3,n.par=591:592,n.sim=1:3,np=500,sd.fac=c(1,5,10,15),mle=TRUE)
